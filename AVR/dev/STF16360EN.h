...
#define stf16360enPORT GPORT(STF16360EN_PORT)
#define stf16360enDDR  GDDR(STF16360EN_PORT)

void stf16360enInit();
void stf16360enWrite(uint8* dat,uint8 count);
#define stf16360enEnableOut()	(stf16360enPORT&=~(1<<STF16360EN_ENP))
#define stf16360enDesableOut()	(stf16360enPORT|=(1<<STF16360EN_ENP))

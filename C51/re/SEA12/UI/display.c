...
sbit ch1 = P0^5;
sbit ch2 = P0^4;
#define DISMASK_1 0xF8
#define DISMASK_2 0x38
#define DISP1 P1
#define DISP2 P3
void PollingDisplay()
{
	...
	//dis[0]=DisplayDeviceMemImage[0];
	ch2=true;
	ch1=true;
	DISP1|=DISMASK_1;
	DISP2|=DISMASK_2;
	DISP1&=(DisplayDeviceMemImage[2]|~DISMASK_1);
	DISP2&=(DisplayDeviceMemImage[3]|~DISMASK_2);
	if(ch)
	{
		MC14094BWrite(DisplayDeviceMemImage);
	}
	else
	{
		MC14094BWrite(DisplayDeviceMemImage+1);
	}
	if(ch)
	{
		ch2=false;
